...
(cl:defmethod cl:initialize-instance :after ((m <Bumper>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bumper)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aibo_server-msg:<Bumper> is deprecated: use aibo_server-msg:Bumper instead.")))
...
(cl:defmethod is_pressed-val ((m <Bumper>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aibo_server-msg:is_pressed-val is deprecated.  Use aibo_server-msg:is_pressed instead.")
  (is_pressed m))
